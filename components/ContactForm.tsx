      ...
      <Form onSubmit={handleSubmit} className="text-left">
        <div className="flex flex-col items-start gap-2 text-left">
          ...
          <input
            ...
            className="h-12 w-full rounded-2xl border border-white/10 bg-black/40 px-4 text-left text-white outline-none placeholder:text-white/35 focus:border-purple-400"
          />
        ...
        <div className="flex flex-col items-start gap-2 text-left">
          ...
          <textarea
            ...
            className="min-h-36 w-full resize-none rounded-2xl border border-white/10 bg-black/40 px-4 py-3 text-left text-white outline-none placeholder:text-white/35 focus:border-purple-400"
          />
        ...
        <button
          type="submit"
          className="mt-2 inline-flex h-12 cursor-pointer items-center justify-center rounded-2xl border border-purple-400/40 bg-purple-500/20 px-6 text-sm font-medium uppercase tracking-[0.2em] text-white hover:bg-purple-500/30"
        >
          Enviar
        </button>
      </Form>
